...
class Distibot(object):
    ...
    def __init__(self, conf_filename='distibot.conf'):
        ...
        self.T_sleep = 1
        self.over_cnt = {}
        self.over_cnt['boiler'] = 0
        self.over_cnt['condenser'] = 0
        self.Tstage_reached = {}
        self.Tstage_reached['boiler'] = False
        self.Tstage_reached['condenser'] = False
        self.csv_delay = 0
        self.water_on = False
        self.print_str = []
    ...
    def ts_check(self):
        (is_over, ts_id) = self.tsensors.t_over(self.Tstage)
        if is_over:
            self.over_cnt[ts_id] += 1

        if self.over_cnt['boiler'] > self.temperature_over_limit:
            self.over_cnt['boiler'] = 0
            self.Tstage_reached['boiler'] = True

        if self.over_cnt['condenser'] > self.temperature_over_limit:
            self.over_cnt['condenser'] = 0
            self.Tstage_reached['condenser'] = True
